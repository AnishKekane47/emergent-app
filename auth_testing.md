...
curl -X GET "$REACT_APP_BACKEND_URL/api/transactions" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.context().addCookies([{
    ...
    "domain": "fraud-radar.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://fraud-radar.preview.emergentagent.com");
```
